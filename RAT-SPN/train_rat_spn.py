...
def run_training():
    ...
    # Load data #
    #############
    #if ARGS.data_set in ['mnist_missing','fashion_mnist_missing']:
        #train_x, train_labels, valid_x, valid_labels, test_x, test_labels = datasets.load_mnist_missing(ARGS.data_path)
